...
class RealTimeStatus extends StatefulWidget {
  ...
  const RealTimeStatus({super.key, this.username});
...
class _RealTimeStatusState extends State<RealTimeStatus> {
  ...
  Future<void> _fetchDriverStatus() async {
    try {
      final url = Uri.parse('$baseUrl/current-driver-status?username=${widget.username}');
                ...
                AnimatedDefaultTextStyle(
                  ...
                  child: Text(
                    _driverStatus.isNotEmpty
                        ? _driverStatus[0].toUpperCase() +
                              _driverStatus.substring(1)
                        : _driverStatus,
                  ),
                ),
              ],
                ...
                children: [
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: RealTimeStatusReport(username: widget.username),
                    ),
                  ),
                  Text(
                    "Event Logs",
                  ...
                  SizedBox(height: 8),
                  Expanded(flex: 1, child: CurrentEventsList(username: widget.username)),
                ],
              ),
            ),
          ],
